...
from refactored_parsing import ArgumentParser

from .testutils import Parseable, parametrize, raises, raises_missing_required_arg
...
def test_basic_required_argument(simple_attribute, silent):
    ...
    @dataclass
    class SomeDataclass(Parseable):
        some_attribute: some_type  # type: ignore

    actual = SomeDataclass.parse_args(f"--some_attribute {passed_value}")
